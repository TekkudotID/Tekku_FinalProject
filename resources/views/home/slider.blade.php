...
<div class="mu-single-slide">
    <img src="{{asset('assets/img/slider-img-1.jpg')}}"slider img">
    <div class="mu-single-slide-content-area">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="mu-single-slide-content">
                        <h1>Welcome to Tekku</h1>
...
<!-- Start single slide  -->
<div class="mu-single-slide">
    <img src="{{asset('assets/img/slider-img-2.jpg')}}" alt="slider img">
    <div class="mu-single-slide-content-area">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
...
<!-- Start single slide  -->
<div class="mu-single-slide">
    <img src="{{asset('assets/img/slider-img-3.jpg')}}" alt="slider img">
    <div class="mu-single-slide-content-area">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
